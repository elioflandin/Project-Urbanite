 ...
 */
typedef enum {
    OFF = 0,          /*!< Starting state. No measurement or display active. Also comes here when the button has been pressed for the required time to turn OFF the Urbanite */
 ...
 *
 * The fields of this structure are private and defined in the .c file (fsm_urbanite.c).
 */
...
/**
 * @brief Destroy the urbanite FSM and free its memory.
 * 
 ...
 *
 * This function creates a new Urbanite FSM with the given button, ultrasound, display FSMs 
 * and the required times for configuration.
 *
 ...
 * @return fsm_urbanite_t* Pointer to the created Urbanite FSM.
 */
